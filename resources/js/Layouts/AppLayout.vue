...
const { props } = usePage();
const routeHasLogin = ref(props.routeHasLogin || false);
const isAuthenticated = ref(props.isAuthenticated || false);
                ...
                <div class="flex flex-1 items-center justify-end md:justify-between">
                    <nav aria-label="Global" class="hidden md:block">
                        <ul class="flex items-center gap-6 text-sm">
                            ...
                            <li>
                                <a class="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" href="https://github.com/HirasawaProject">
                                    Guithub
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div v-if="$page.props.auth.user">
                            <a :href="homeUrl" class="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700 dark:hover:bg-teal-500">
                            Home
                            </a>
                        </div>
                        <div v-else>
                            <a :href="loginUrl" class="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700 dark:hover:bg-teal-500">
                            Log in
                            </a>
                            <a :href="registerUrl" class="hidden sm:block rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600 transition hover:text-teal-600/75 dark:bg-gray-800 dark:text-white dark:hover:text-white/75">
                            Register
                            </a>
                        </div>
                        </div>
